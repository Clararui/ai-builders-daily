...
(async()=>{
 ...
 for(let i=0;i<count;i++){
   await page.evaluate(i=>presentation.showSlide(i),i);await page.waitForTimeout(250);
 ...
 await page.evaluate(()=>presentation.showSlide(0));await page.screenshot({path:resolve(out,'layout-desktop.png')});
 await page.setViewportSize({width:390,height:844});await page.screenshot({path:resolve(out,'layout-phone.png')});
